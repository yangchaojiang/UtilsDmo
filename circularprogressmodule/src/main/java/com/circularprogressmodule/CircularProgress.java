package com.circularprogressmodule;
...
public class CircularProgress extends View {
    ...
    public CircularProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        a.recycle();
        mColors = new int[4];
        mColors[0] = a.getColor(R.styleable.CircularProgress_color_0, context.getResources().getColor(android.R.color.transparent));
        mColors[1] = a.getColor(R.styleable.CircularProgress_color_0, context.getResources().getColor(android.R.color.holo_orange_dark));
        mColors[2] = a.getColor(R.styleable.CircularProgress_color_0, context.getResources().getColor(android.R.color.darker_gray));
        mColors[3] = a.getColor(R.styleable.CircularProgress_color_0, context.getResources().getColor(android.R.color.holo_blue_dark));
